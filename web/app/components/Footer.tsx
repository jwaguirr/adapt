        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Adapt</span>
            </div>
            <p className="text-stone-300 mb-6 max-w-md">
              Experience seamless language learning and translation with our advanced AR technology. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/flashcards" className="text-stone-300 hover:text-white transition-colors">
                  Flashcards
                </Link>
              </li>
              <li>
                <Link href="/dialogue-duel" className="text-stone-300 hover:text-white transition-colors">
                  Dialogue Duel
                </Link>
              </li>
              <li>
                <Link href="/second-chance" className="text-stone-300 hover:text-white transition-colors">
                  Second Chance
                </Link>
              </li>
              <li>
